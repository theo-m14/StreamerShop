 ...
 */
final class Version20240914085237 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sub_advantages (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sub_advantages_plan (sub_advantages_id INT NOT NULL, plan_id INT NOT NULL, INDEX IDX_74690A002589748C (sub_advantages_id), INDEX IDX_74690A00E899029B (plan_id), PRIMARY KEY(sub_advantages_id, plan_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE sub_advantages_plan ADD CONSTRAINT FK_74690A002589748C FOREIGN KEY (sub_advantages_id) REFERENCES sub_advantages (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE sub_advantages_plan ADD CONSTRAINT FK_74690A00E899029B FOREIGN KEY (plan_id) REFERENCES plan (id) ON DELETE CASCADE');
